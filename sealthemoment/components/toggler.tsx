...
function Toggler() {
    ...
    return(
        ...
        >
            <label htmlFor="dark" className="toggler__label"
            onClick={setDarkMode}>Dark Mode</label>
            <div className="toggler__wrapper">
                ...
                "toggler__button toggler__button--light" : "toggler__button toggler__button--dark"}></span>
            </div>
            <label htmlFor="light" className="toggler__label" onClick={setLightMode}>Light Mode</label>
        </fieldset>
    )
}
