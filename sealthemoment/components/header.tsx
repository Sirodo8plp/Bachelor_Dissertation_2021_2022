    ...
    <header className="header">
      <section className="header__text">
        ...
        <p className="header__info">
          Take a photograph wherever you are, convert it to NFT and make your
          moments unique!
        </p>
      </section>
      <section className="header__images">
        ...
        <figure className="header__figure header__figure--bottomRight">
          <Image layout="fill" objectFit="cover" src={fillerPic2} />
        </figure>
        <figure className="header__figure header__figure--upRight">
          <Image layout="fill" objectFit="cover" src={fillerPic1} />
        </figure>
      </section>
    </header>
  );
